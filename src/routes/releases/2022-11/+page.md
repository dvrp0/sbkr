...
외에도 여느 때와 마찬가지로 일부 밸런스가 변경됩니다.
  ...
  - **<CardLink>혼돈의 제자</CardLink>**: <Old>사망 시, 인접한 무작위 적 하나에게 3/4/5/6/7 데미지를 입힙니다</Old> → 사망 시, 인접한 무작위 적들에게 4/5/6/7/8 데미지를 나누어 입힙니다
  - **<CardLink>요새 강화제</CardLink>**: 체력 부여량 <Old>2/3/4/5/6</Old> → 3/4/5/6/7
  - **<CardLink>황혼을 부르는 노인</CardLink>**: 체력 <Old>5/6/7/8/10</Old> → 6/7/8/9/11
  - **<CardLink>방랑하는 시의원</CardLink>**: 데미지 <Old>3/3/4/4/5</Old> → 받은 데미지만큼
  - **<CardLink>반복자 바벨</CardLink>**: 체력 <Old>2/3/4/4/5</Old> → 1/2/3/3/4
  - **<CardLink>대예언자 브라그다</CardLink>**: 대상 유닛 수 <Old>모두</Old> → 2/3/3/4/4명
...
<Card type="unit" faction="ironclad" name="전선 기술자" unitType="컨스트럭트" cost=4 strengths={[2, 3, 4, 4, 5]} movement=1 rarity="rare" cardart="/images/cards/cardart_U319.png" abilities={[
...
<Card type="building" faction="swarm" name="저주받은 묘지" cost=4 strengths={[3, 4, 5, 6, 7]} rarity="common" cardart="/images/cards/cardart_B204.png" abilities={[
...
신규 카드의 0 마나 버전이 덱에 자동으로 추가됩니다(즉 모든 덱이 13장). 신규 카드를 소유하고 있지 않거나 레벨을 올리지 않았다면 1레벨로, 레벨을 올렸다면 해당 레벨로 추가됩니다.
  ...
  - 11월 10일에 시작하는 워리어 난투는 **<CardLink>저주받은 묘지</CardLink>** 난투입니다.
  - 11월 17일에 시작하는 워리어 난투는 **<CardLink>전선 기술자</CardLink>** 난투입니다.
