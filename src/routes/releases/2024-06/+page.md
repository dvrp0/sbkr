...
## 새로운 기지 레벨링 체계
이번 패치에서는 기지 레벨링 체계가 재설계되어 단순히 카드를 수집하고 레벨을 올리는 것 이외에도 다양한 게임 내 활동을 통해 경험치 포인트(EXP) 획득이 가능해집니다.

플레이어는 다양한 활동을 진행함으로써 경험치를 모을 수 있고, 일정량의 경험치를 획득하면 기지의 체력이 증가합니다.
...
저희는 현재 설정된 게임 내 활동들의 경험치 지급량이 적절하다고 판단하고 있으나, 관련된 데이터가 수집됨에 따라 수치들이 조금씩 조정될 수 있습니다.

또한 이미 기지 레벨 20에 도달한 플레이어들을 위한 새로운 체계가 기획 중에 있습니다. 다만 작업에 들어가기에 앞서 먼저 충분한 데이터를 모아 해당 체계가 플레이어들이 진정으로 원하는 것을 제공할 수 있도록 하고자 합니다.

### 진척도
플레이어는 플레이어 프로필 팝업 창에서 현재 기지 레벨과 다음 레벨까지의 진척도를 확인할 수 있습니다. 이 창에는 게임 내 활동 목록과 각 활동이 지급하는 경험치 또한 표시됩니다.
...
이 체계는 플레이어들의 성장 곡선을 더욱 합리적인 방향으로 다듬고 활발한 플레이어를 효과적으로 보상하기 위해 설계되었습니다. 새로운 기지 레벨링 체계는 기지 레벨을 성장시키는 일련의 과정을 통해 궁극적으로 기지 함락자보다 훨씬 많은 양의 자원을 제공합니다.
...
### 해적 선물
이벤트 기간 동안 모든 분들께 <Icon type="coin" /> 200 코인의 특별 선물을 드립니다. 선물을 받으시려면 **이벤트가 종료되기 전까지** 특별 코드 **PIRATEGOLD**를 입력하세요.
