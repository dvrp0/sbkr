...
summary: 3월에는 신규 카드 2장이 추가되고, 일부 밸런스가 조정되며, 성 패트릭의 날 이벤트가 진행됩니다!
...
## 성 패트릭의 날 이벤트
점점 가까워지는 성 패트릭의 날(3월 17일)을 기념하기 위해 작은 이벤트가 진행됩니다. 성 패트릭의 날 이벤트가 진행되는 3월 17일부터 3월 27일까지 코인과 루비를 구매하면 추가로 지급됩니다.
...
또한 각기 다른 아바타를 포함하는 성 패트릭의 날 특별 상품 또한 판매될 예정입니다.
...
드래프트 모드가 스톰바운드에 추가된 지 1년이 넘었습니다. 따라서 드래프트를 일부 변경해 더욱 많은 플레이어들이 즐겁게 플레이할 수 있도록 하고자 합니다. 변경점은 다음과 같습니다.
  ...
  4. **드래프트 세션을 시작하는 데 필요한 코인의 개수가 변경됩니다**. 첫 번째 세션에는 <Icon type="coin" /> 600 코인이 필요하며 다음 세션의 비용이 200씩 증가합니다(600 → 800 → 1000 → 1200 → ...).
...
아래에서 3월 업데이트에 대한 자세한 일정을 확인하시기 바랍니다.
  ...
  - **성 패트릭의 날 기념 선물 (200 코인)**: 3월 17일 오후 4시 ~ 3월 20일 오후 4시
  - **잎보듬이 출시**: 3월 17일 오후 4시
  - **성 패트릭의 날 코인 보너스**: 3월 17일 오후 4시 ~ 3월 27일 오후 4시
  - **성 패트릭의 날 루비 보너스**: 3월 17일 오후 4시 ~ 3월 27일 오후 4시
  - **성 패트릭의 날 특별 상품**: 3월 17일 오후 4시 ~ 3월 27일 오후 4시
